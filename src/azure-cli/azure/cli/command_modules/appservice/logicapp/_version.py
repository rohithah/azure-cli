    ...
    return {
        ...
        "synthesised": {
            ...
            "reason": (
                ...
                "accepts. nextContinuationToken is minted by the CLI, not by the "
                "platform: it is an opaque CLI-internal cursor encoding an offset "
                "into the single collection the route returns, and is not a platform "
                "value under any other name. "
